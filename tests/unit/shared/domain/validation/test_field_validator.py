...
from src.shared.domain.validation import FieldValidator, ValidationContext
...
class TestFieldValidator:
    ...
    def test_currency_invalid(self):
        invalid_currency = ["invalid-currency", 0, -1, 12.123]
