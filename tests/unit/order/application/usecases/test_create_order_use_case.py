...
class TestCreateOrderUseCase:
    ...
    def create_order_use_case(
        self, repository: OrderRepository, domain_event_publisher: DomainEventPublisher
    ) -> CreateOrderUseCase:
        return CreateOrderUseCase(
            repository=repository, domain_event_publisher=domain_event_publisher
        )

    def test_create_order_use_case_is_use_case_instance(
        self, create_order_use_case: CreateOrderUseCase
    ):
        assert isinstance(create_order_use_case, UseCase)

    def test_create_order_use_case_execute_with_valid_input(
        self, create_order_use_case: CreateOrderUseCase
    ):
    ...
    def test_create_order_use_case_execute_with_invalid_input(
        self, create_order_use_case: CreateOrderUseCase
    ):
        ...
        assert result.errors[0] == UUIDFormatError(
            field_name="customer_id", current_value="invalid"
        )

    def test_create_order_use_case_should_call_repository_with_valid_input(
        self, create_order_use_case: CreateOrderUseCase
    ):
        customer_id = str(uuid.uuid4())
    ...
    def test_create_order_use_case_should_return_failure_when_repository_fails(
        self, create_order_use_case: CreateOrderUseCase
    ):
        customer_id = str(uuid.uuid4())
        create_order_use_case.repository.save.return_value = Result.fail(
    ...
    def test_create_order_use_case_should_call_domain_event_publisher_with_valid_input(
        self, create_order_use_case: CreateOrderUseCase
    ):
        customer_id = str(uuid.uuid4())
